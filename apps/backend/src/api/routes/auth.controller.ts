...
import { ForgotReturnPasswordDto } from '@collosy/nestjs-libraries/dtos/auth/forgot-return.password.dto';
import { ForgotPasswordDto } from '@collosy/nestjs-libraries/dtos/auth/forgot.password.dto';
import { ResendActivationDto } from '@collosy/nestjs-libraries/dtos/auth/resend-activation.dto';
import { ApiTags } from '@nestjs/swagger';
import { getCookieUrlFromDomain } from '@collosy/helpers/subdomain/subdomain.management';
import { EmailService } from '@collosy/nestjs-libraries/services/email.service';
import { RealIP } from 'nestjs-real-ip';
import { UserAgent } from '@collosy/nestjs-libraries/user/user.agent';
...
export class AuthController {
  ...
  mobileCallback(
    ...
    const scheme = process.env.MOBILE_APP_SCHEME || 'collosy://auth/callback';
