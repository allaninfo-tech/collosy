...
import { CreateOAuthAppDto } from '@collosy/nestjs-libraries/dtos/oauth/create-oauth-app.dto';
import { UpdateOAuthAppDto } from '@collosy/nestjs-libraries/dtos/oauth/update-oauth-app.dto';
