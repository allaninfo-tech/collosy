...
import { StarsAndForks } from '@collosy/frontend/components/analytics/stars.and.forks';
import { FC, useCallback } from 'react';
import { StarsTableComponent } from '@collosy/frontend/components/analytics/stars.table.component';
